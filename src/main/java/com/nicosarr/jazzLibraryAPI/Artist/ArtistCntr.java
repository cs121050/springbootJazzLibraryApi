...
/*
	...
	public String create(@RequestParam("artist_name") String name, @RequestParam("artist_surname") String surname,
			@RequestParam("instrument_id") int instrumentId, @RequestParam("artist_rank") int artistRank) {
		Artist artist = new Artist(name, surname, instrumentId, artistRank);
...
//                .body(result == 1 ? "Artist creation Success" : "Artist creation Failed");        
	...
	public String updateArtistInstrumentId(@RequestParam("artist_id") int artistId,
			@RequestParam("artist_name") String artistName, @RequestParam("artist_surname") String artistSurname,
			@RequestParam("instrument_id") int instrumentId, @RequestParam("artist_rank") int artistRank) {
		Artist artist = new Artist(artistId, artistName, artistSurname, instrumentId, artistRank);
	...
	public Artist retrieveArtistByNameAndInstrumentId(@RequestParam("artist_name") String artistName,
			@RequestParam("artist_surname") String artistSurname, @RequestParam("instrument_id") int instrument_id) {
...
//    }
	...
	public List<Artist> retrieveArtistAndVideoCountByInstrumentTypeAndDuration(
			@RequestParam("instrument_id") int instrumentId, @RequestParam("type_id") int typeId,
			@RequestParam("duration_id") int durationId) {
