...
def check_video_status(video_id):
    ...
    try:
        ...
        if resp.status_code == 200:
            ...
            # ----- EMBED-DISABLED (with improved detection) -----
            if ('embeddable":false' in content or
                'playback on other websites has been disabled' in content or
                'error' in content or
                ('watch on youtube' in content and 'disabled' in content)):
            ...
            # ----- MEMBERS ONLY (expanded) -----
            if ('members only' in content or
                'members-only' in content or
                'this video is available to this channel\'s members' in content or
                'granted you access' in content or
                'subscrib' in content or
                'watch video on youtube' in content or
                'Watch video on YouTube' in content or
                'Error 153' in content or
                'error 153' in content or
                'error' in content or
                'join this channel to get access' in content):
